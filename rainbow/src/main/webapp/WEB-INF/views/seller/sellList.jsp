				...
				<div id="v6Contents">
					...
					<div id="v6RightContent">
						<div class="v6Location">
							현재위치 : <a href="/main.do">HOME</a> &gt; <a href="/seller/sellMain.do">판매관리</a> &gt; 상품판매관리 &gt; <b>상품목록</b>
						</div>
						<div id="v5ContentsWrap">
							...
							<form name="schFrm" id="schFrm" method="get" action="/seller/sellList.do">
								...
								<table class="common_table_normal" id="searchTbl">
									<tbody>
										<tr>
											<td colspan="6">
												<select class="select_default" name="day_type" style="width: 110px;">
													<option value="1" ${resultDataMap.day_type eq '1' ? 'selected':'' }>주문일기준</option>
													<option value="2" ${resultDataMap.day_type eq '2' ? 'selected':'' }>발송일기준</option>
												</select>
										...
										<tr>
											<th>주문번호</th>
											<td>
												<input type="text" name="order_no" value="${resultDataMap.order_no }" style="width: 85px;"/>
											</td>
											<th>주문상태</th>
											<td>
											...
											<th>주문명</th>
											<td >
												<input type="text" name="order_name" value="${resultDataMap.order_name }" style="width:85px;"/>
											</td>
										</tr>
										<tr>
											<th>구매자</th>
											<td>
												<input type="text" name="buyer_id" value="${resultDataMap.buyer_id }" style="width:85px;"/>
											</td>
											<th>수량</th>
											<td>
												<input type="text" name="order_qty" value="${resultDataMap.order_qty }" style="width:85px;"/>
											</td>
											<th>금액</th>
											<td>
												<input type="text" name="order_price" value="${resultDataMap.order_price }" style="width:85px;"/>
											</td>
										</tr>
									</tbody>
								</table>
							...
							<c:choose>
								<c:when test="${empty resultDataMap.sellList }">
										<tr>
											<td colspan="7" class="center">검색된 주문서가 없습니다.</td>
										</tr>
								</c:when>
								<c:otherwise>
