...
<script type="text/javascript" src="/js/seller/itemQaList.js"></script>
				...
				<div id="v6Contents">
					...
					<div id="v6RightContent">
						<div class="v6Location">
							현재위치 : <a href="/main.do">HOME</a> &gt; <a href="/seller/sellMain.do">판매관리</a>&gt; <a href="/seller/sellMain.do">상품문의관리</a> &gt; <b>상품문의목록</b>
						</div>
						...
						<div id="v5ContentsWrap">
							...
							<!-- 검색 -->
							<form id="schFrm" name="schFrm" method="get" action="/seller/itemQaList.do">
						...
						<c:choose>
							<c:when test="${empty resultDataMap.qaList }">
								<div style="text-align:center; margin-top:40px;">조회된 문의글이 없습니다</div>
							</c:when>
							<c:otherwise>
								<c:forEach var="data" items="${resultDataMap.qaList }">
